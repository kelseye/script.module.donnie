...
CREATE TABLE IF NOT EXISTS `rw_stream_list` ( `streamid` int(11) NOT NULL AUTO_INCREMENT, `stream` varchar(75) DEFAULT NULL, `url` varchar(125) DEFAULT NULL, `priority` decimal(3,1) DEFAULT NULL, `machineid` varchar(75) DEFAULT NULL, PRIMARY KEY (`streamid`)) ENGINE=InnoDB;
